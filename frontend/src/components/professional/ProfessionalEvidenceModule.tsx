...
export default function ProfessionalEvidenceModule({
    ...
    const assessment = () => (
        <div className="space-y-4">
            <p className="text-slate-600">The professional skill assessment is available from the dedicated assessment workspace and is saved to your account.</p>
            <a href="/working_professional/skill-assessment" className="inline-flex rounded-xl bg-cyan-600 px-5 py-3 font-semibold text-white">Open Skill Assessment</a>
        </div>
    );
