import { CheckCircle, UserRound, Target, Sparkles, Rocket } from "lucide-react";
        ...
        <div className="flex w-full max-w-[460px] items-center justify-center">
          <div className="relative w-full overflow-hidden rounded-[30px] border border-white/80 bg-white p-6 shadow-[0_24px_70px_rgba(15,23,42,0.12)]">
            ...
            <div className="relative flex items-start justify-between gap-4">
              ...
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-cyan-500 to-violet-500 text-white shadow-lg">
                <Sparkles size={22} />
              </div>
            </div>
