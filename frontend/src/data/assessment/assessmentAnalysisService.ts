...
export type AssessmentSkill = "Numerical Ability" |
    "Arithmetic" |
    "Logical Reasoning" |
    "Analytical Thinking" |
    "Problem Solving" |
...
export const aptitudeQuestions: Question[] = [
    {
        id: 1,
        question: "A shopkeeper marks an item at ₹1,200 and gives a 15% discount. What is the selling price?",
        options: [
            "₹980",
            "₹1,000",
            "₹1,020",
    ...
    {
        id: 2,
        question: "The ratio of boys to girls in a class is 3:2. If there are 40 students, how many are girls?",
        options: [
            "14",
            "16",
            "20",
    ...
    {
        id: 4,
        question: "A student completes 3/5 of a project in 6 days at a constant rate. How many more days are needed to finish the project?",
        options: [
            "2",
            "3",
            "4",
    ...
    {
        id: 5,
        question: "All scientists are curious. Some curious people are writers. Which statement is definitely true?",
        options: [
    ...
    {
        id: 6,
        question: "The average of five numbers is 24. Four numbers are 18, 21, 25 and 26. What is the fifth number?",
        options: [
            "28",
            "30",
            "32",
    ...
    {
        id: 7,
        question: "A train covers 180 km in 3 hours. At the same speed, how far will it travel in 4.5 hours?",
        options: [
            "240 km",
            "250 km",
            "270 km",
    ...
    {
        id: 8,
        question: "Find the odd one out: 16, 25, 36, 45, 49.",
        options: [
            "16",
            "25",
            "45",
    ...
    {
        id: 9,
        question: "A school has ₹18,000 for 12 identical science kits. What is the maximum cost per kit?",
        options: [
            "₹1,200",
            "₹1,400",
            "₹1,500",
    ...
    {
        id: 10,
        question: "If P is north of Q and R is east of P, in which direction is R from Q?",
        options: [
            "North-West",
            "North-East",
            "South-East",
    ...
    {
        id: 12,
        question: "If 8 workers complete a task in 15 days, how many days would 12 equally efficient workers take?",
        options: [
            "8",
            "10",
            "12",
    ...
    {
        id: 14,
        question: "A student must choose exactly two activities from Coding, Music and Sports. If Coding is chosen, Sports cannot be chosen. Which pair is possible?",
        options: [
            "Coding and Sports",
            "Coding and Music",
            "All three",
    ...
    {
        id: 15,
        question: "Meera scored more than Rohan but less than Aditi. Kabir scored less than Rohan. Who scored the highest?",
        options: [
            "Meera",
            "Rohan",
            "Aditi",
...
export const mathQuestions: Question[] = [
    ...
    {
        id: 103,
        question: "A right triangle has perpendicular sides 6 cm and 8 cm. What is the hypotenuse?",
        options: [
            "9 cm",
            "10 cm",
            "12 cm",
    ...
    {
        id: 106,
        question: "The circumference of a circle is 44 cm. Using π = 22/7, what is its radius?",
        options: [
            "5 cm",
            "7 cm",
            "10 cm",
    ...
    {
        id: 109,
        question: "A linear equation has graph y = 2x + 3. What is y when x = 4?",
        options: [
            "8",
            "9",
            "10",
    ...
    {
        id: 112,
        question: "The area of a square is 196 cm². What is its perimeter?",
        options: [
            "28 cm",
            "42 cm",
            "56 cm",
    ...
    {
        id: 114,
        question: "A quantity changes from 80 to 100. What is the percentage increase?",
        options: [
            "20%",
            "25%",
            "40%",
    ...
    {
        id: 115,
        question: "A cylindrical tank has radius 3 m and height 5 m. Which expression gives its volume?",
        options: [
            "15π m³",
            "30π m³",
            "45π m³",
...
export const englishQuestions: Question[] = [
    ...
    {
        id: 203,
        question: "Aarav noticed that rereading notes did not effectively test his learning. He started using practice questions and weekly self-checks. Why did Aarav change his study plan?",
        options: [
    ...
    {
        id: 204,
        question: "Choose the correct reported speech: Riya said, 'I am preparing for the exam.'",
        options: [
    ...
    {
        id: 206,
        question: "A school introduced a digital library, but students who followed a weekly reading schedule showed the greatest improvement. What is the main idea?",
        options: [
    ...
    {
        id: 207,
        question: "Fill in the blank: By the time the teacher arrived, the students ___ the experiment.",
        options: [
            "complete",
            "completed",
            "had completed",
    ...
    {
        id: 208,
        question: "Her explanation was so ___ that even a difficult concept became easy to understand.",
        options: [
            "vague",
            "clear",
            "random",
    ...
    {
        id: 209,
        question: "Kavya prefers projects where she can research a problem, compare evidence and explain her conclusion. Which activity best matches her preference?",
        options: [
    ...
    {
        id: 210,
        question: "Choose the correct passive form of: 'The team completed the project.'",
        options: [
    ...
    {
        id: 211,
        question: "What does 'evaluate' most nearly mean?",
        options: [
            "Ignore",
            "Assess",
            "Repeat",
    ...
    {
        id: 212,
        question: "A city planted trees along busy roads. Some areas later recorded lower surface temperatures and improved shade. Which conclusion is best supported?",
        options: [
    ...
    {
        id: 214,
        question: "Choose the meaning of 'infer'.",
        options: [
    ...
    {
        id: 215,
        question: "Dev reviewed his mock-test errors and found that most came from time pressure and skipped calculation steps. What should Dev most logically improve?",
        options: [
            "Only handwriting",
...
export const scienceQuestions: Question[] = [
    {
        id: 301,
        question: "A car increases its speed from 10 m/s to 20 m/s in 5 seconds. What is its acceleration?",
        options: [
            "1 m/s²",
            "2 m/s²",
            "5 m/s²",
    ...
    {
        id: 302,
        question: "Two resistors of 2 Ω and 4 Ω are connected in series. What is their equivalent resistance?",
        options: [
            "1.3 Ω",
            "2 Ω",
            "6 Ω",
    ...
    {
        id: 303,
        question: "Why does a pencil appear bent when partly immersed in water?",
        options: [
            "Reflection",
            "Refraction",
            "Dispersion",
    ...
    {
        id: 304,
        question: "An object is placed in front of a plane mirror. Which statement about its image is correct?",
        options: [
    ...
    {
        id: 305,
        question: "Which energy conversion mainly occurs in an electric fan?",
        options: [
    ...
    {
        id: 306,
        question: "Which substance will most likely turn blue litmus paper red?",
        options: [
            "Soap solution",
            "Lime water",
    ...
    {
        id: 307,
        question: "In the reaction Zn + 2HCl → ZnCl₂ + H₂, which gas is released?",
        options: [
            "Oxygen",
            "Hydrogen",
            "Chlorine",
    ...
    {
        id: 308,
        question: "Why is galvanisation used on iron objects?",
        options: [
    ...
    {
        id: 310,
        question: "A solution has pH 9. Which statement is most appropriate?",
        options: [
            "It is acidic",
            "It is basic",
            "It is neutral",
    ...
    {
        id: 311,
        question: "Which cell organelle is primarily responsible for releasing energy through cellular respiration?",
        options: [
            "Nucleus",
            "Mitochondrion",
            "Ribosome",
    ...
    {
        id: 313,
        question: "A plant shoot bends toward light mainly because of the action of:",
        options: [
            "Insulin",
            "Auxin",
            "Adrenaline",
    ...
    {
        id: 314,
        question: "Why is variation important in a population?",
        options: [
    ...
    {
        id: 315,
        question: "Which sequence correctly represents a simple food chain?",
        options: [
            "Tiger → Grass → Deer",
            "Grass → Deer → Tiger",
            "Deer → Tiger → Grass",
...
export const reasoningQuestions: Question[] = [
    ...
    {
        id: 403,
        question: "Five students P, Q, R, S and T stand in a line. P is before Q, R is after Q and S is before P. Which order is possible?",
        options: [
            "P-S-Q-R-T",
            "S-P-Q-R-T",
            "Q-P-S-R-T",
    ...
    {
        id: 405,
        question: "All laptops are devices. Some devices are portable. Which conclusion must be true?",
        options: [
    ...
    {
        id: 406,
        question: "A clock gains 5 minutes every hour. If it is correct at 8:00 AM, what will it show at actual 12:00 noon?",
        options: [
            "12:05 PM",
            "12:15 PM",
            "12:20 PM",
    ...
    {
        id: 408,
        question: "A is the sister of B. B is the son of C. How is A related to C?",
        options: [
            "Daughter",
            "Mother",
            "Sister",
    ...
    {
        id: 409,
        question: "A student walks 4 km north, 3 km east and then 4 km south. How far and in which direction is the student from the starting point?",
        options: [
            "3 km east",
            "3 km west",
            "4 km north",
    ...
    {
        id: 410,
        question: "Find the next letter group: AB, DE, GH, JK, ?",
        options: [
            "LM",
            "MN",
            "NO",
    ...
    {
        id: 411,
        question: "If some artists are teachers and all teachers are readers, which conclusion follows?",
        options: [
    ...
    {
        id: 412,
        question: "A test has 40 questions. A student gets 3 marks for each correct answer and loses 1 mark for each wrong answer. All questions are attempted and 30 are correct. What is the score?",
        options: [
            "70",
            "80",
            "90",
    ...
    {
        id: 413,
        question: "Find the next number: 7, 10, 16, 25, 37, ?",
        options: [
            "49",
            "50",
            "52",
    ...
    {
        id: 414,
        question: "No engineer is careless. Some students are engineers. Which conclusion is valid?",
        options: [
    ...
    {
        id: 415,
        question: "Three boxes are labelled Apples, Oranges and Mixed, but every label is wrong. From which box should you pick one fruit first to identify all boxes?",
        options: [
            "Apples",
            "Oranges",
            "Mixed",
...
export type StudentStream = "Science PCM" |
    "Science PCB" |
    "Science PCMB" |
...
export type AssessmentCategory = "aptitude" |
    "math" |
    "english" |
    "science" |
    "reasoning";
...
export const class10AssessmentQuestionBank: AssessmentQuestionBank = {
...
export const class11PCBQuestionBank: AssessmentQuestionBank = {
    aptitude: aptitudeQuestions,
    math: mathQuestions,
    english: englishQuestions,
    science: scienceQuestions,
...
export const class11PCMBQuestionBank: AssessmentQuestionBank = {
    aptitude: aptitudeQuestions,
    math: mathQuestions,
    english: englishQuestions,
    science: scienceQuestions,
...
export const class11CommerceQuestionBank: AssessmentQuestionBank = {
    aptitude: aptitudeQuestions,
    math: mathQuestions,
    english: englishQuestions,
    science: scienceQuestions,
...
export const class11HumanitiesQuestionBank: AssessmentQuestionBank = {
    aptitude: aptitudeQuestions,
    math: mathQuestions,
    english: englishQuestions,
    science: scienceQuestions,
...
export const class12PCMQuestionBank: AssessmentQuestionBank = {
    aptitude: aptitudeQuestions,
    math: mathQuestions,
    english: englishQuestions,
    science: scienceQuestions,
...
export const class12PCBQuestionBank: AssessmentQuestionBank = {
    aptitude: aptitudeQuestions,
    math: mathQuestions,
    english: englishQuestions,
    science: scienceQuestions,
...
export const class12PCMBQuestionBank: AssessmentQuestionBank = {
    aptitude: aptitudeQuestions,
    math: mathQuestions,
    english: englishQuestions,
    science: scienceQuestions,
...
export const class12CommerceQuestionBank: AssessmentQuestionBank = {
    aptitude: aptitudeQuestions,
    math: mathQuestions,
    english: englishQuestions,
    science: scienceQuestions,
...
export const class12HumanitiesQuestionBank: AssessmentQuestionBank = {
    aptitude: aptitudeQuestions,
    math: mathQuestions,
    english: englishQuestions,
    science: scienceQuestions,
...
function getClass11QuestionBank(
    ...
    const stream = normalizeStream(currentStream);
...
export function getAssessmentQuestionBank({
    studentClass, currentStream,
}: AssessmentQuestionContext): AssessmentQuestionBank {
    switch (studentClass) {
        case "9":
...
export const assessmentQuestionBank = class10AssessmentQuestionBank;
/* QUESTION RESOLVERS */
...
export function getContextualAssessmentQuestions(
    ...
    const questionBank = getAssessmentQuestionBank(context);
