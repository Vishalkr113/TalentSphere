...
const achievements = [
  {
    ...
    description:
      "Completed all placement preparation modules.",
    icon: Trophy,
  ...
  },
  {
    ...
    description:
      "Solved 500+ coding problems successfully.",
    icon: Medal,
    color: "text-cyan-600",
    bg: "bg-cyan-100",
  },
  {
    title: "Resume Expert",
    description:
      "Achieved an ATS Resume Score above 90%.",
    icon: Award,
  ...
  },
  {
    ...
    description:
      "Completed 50+ AI mock interviews.",
    icon: BadgeCheck,
  ...
  },
  {
    ...
    description:
      "Finished all technical skill assessments.",
    icon: Star,
  ...
  },
  {
    title: "Top Performer",
    description:
      "Maintained excellent weekly learning progress.",
    icon: TrendingUp,
    color: "text-pink-600",
    bg: "bg-pink-100",
  },
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="mt-3 text-lg text-slate-600">
          Track your accomplishments and unlock badges as
          you progress through your career journey.
        </p>
