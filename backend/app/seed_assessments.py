...
def get_assessment_type(question):
    ...
    explicit = getattr(question, "assessment_type", None)
    if explicit:
        return explicit
    mappings = [
        ("HS-COMMON", "high_school_foundation"), ("HS-PCM", "high_school_pcm"),
        ("HS-PCB", "high_school_pcb"), ("HS-COMMERCE", "high_school_commerce"),
        ("HS-ART", "high_school_arts"),
        ("APT-", "college_aptitude"), ("REA-", "logical_reasoning"),
        ("COD-", "college_coding"), ("DSA-", "college_dsa"),
        ("COLLEGE-COMMON", "college_common"), ("COLLEGE-DSA", "college_dsa"),
        ("COLLEGE-TECH", "college_technical"), ("COLLEGE-CAREER", "college_career"),
        ("PROFESSIONAL-COMMON", "professional_common"),
        ("PROFESSIONAL-TECH", "professional_technical"),
        ("PROFESSIONAL-DSA", "professional_dsa"),
        ("PROFESSIONAL-SITUATIONAL", "professional_situational"),
    ]
    for prefix, assessment_type in mappings:
        if code.startswith(prefix): return assessment_type
    return "aptitude"
